...
def decode_from_morse(code):
    if language == 'en':
        morse_code_reverse = {v: k for k, v in en.items()}
    else:
        morse_code_reverse = {v: k for k, v in ru.items()}
    decoded_text = ''
    x61 = code.split('   ')
    x16 = ' # '.join(x61)
...
def main():
    ...
    while True:
        ...
        if a == 'кодировать':
            ...
            print('каким языком вы ходите расшифровать. Если на русском напишите ru, на англиском - en')
            language = input()
